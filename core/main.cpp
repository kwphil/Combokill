...
// --- TEMP ---
        Scene main_scene(3, 0, 0);
        main_scene.spawn_entity("assets/poly.csv", glm::vec3(0.0, 0.0, 0.0));
// --- TEMP ---
...
int init() {
        ...
        camera = make_object<Camera>(glm::vec3(0.0f, 0.5f, 5.0f), glm::vec3(0.0f, 0.0f, -5.0f));
